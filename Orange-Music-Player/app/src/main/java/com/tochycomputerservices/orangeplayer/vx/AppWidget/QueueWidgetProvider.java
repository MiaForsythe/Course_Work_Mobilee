package com.tochycomputerservices.orangeplayer.vx.AppWidget;
...
import com.tochycomputerservices.orangeplayer.vx.Services.QueueWidgetService;
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (mApp.isServiceRunning()) {
                ...
                intent.setAction("com.music.songplayer.action.STOP");
