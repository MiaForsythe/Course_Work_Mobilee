package com.tochycomputerservices.orangeplayer.vx.NowPlaying;
...
import com.tochycomputerservices.orangeplayer.vx.Animations.FadeAnimation;
import com.tochycomputerservices.orangeplayer.vx.Common;
import com.tochycomputerservices.orangeplayer.vx.Dialogs.SongQueueBottomSheet;
...
import com.tochycomputerservices.orangeplayer.vx.VelocityViewPager.VelocityViewPager;
...
//        }
        ...
        mPlayPauseButton = (ImageView) findViewById(R.id.playPauseButton);
        ...
        mRepeatButton = (ImageView) findViewById(R.id.repeatButton);

        mControlsHolderCardView = (LinearLayout) findViewById(R.id.now_playing_controls_header_parent);
...
//            setSeekbarDuration(mApp.getService().getMediaPlayer().getDuration() / 1000);
    ...
    public void addFragment(Fragment fragment) {
        ...
        fragmentTransaction.add(R.id.now_playing_drawer_frame_root, fragment).addToBackStack(null);
