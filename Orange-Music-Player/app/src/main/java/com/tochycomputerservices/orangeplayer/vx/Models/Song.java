...
public class Song  implements Cloneable {
    ...
    public Song(long _id, String _title, String _album, long _albumId, String _artist, long _artistId, String _path, int _trackNumber, long _duration, String _genre) {
        this._id = _id;
        this._title = _title;
        this._album = _album;
        this._albumId = _albumId;
