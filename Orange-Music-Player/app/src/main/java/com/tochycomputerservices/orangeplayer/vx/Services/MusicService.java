...
// To do update deprecated AsyncTask
...
// To do update deprecated preference.PreferenceManager
...
import com.tochycomputerservices.orangeplayer.vx.AppWidget.QueueWidgetProvider;
import com.tochycomputerservices.orangeplayer.vx.AppWidget.SmallWidgetProvider;
import com.tochycomputerservices.orangeplayer.vx.BroadcastReceivers.HeadsetNotificationBroadcast;
import com.tochycomputerservices.orangeplayer.vx.BroadcastReceivers.HeadsetPlugBroadcastReceiver;
import com.tochycomputerservices.orangeplayer.vx.Common;
import com.tochycomputerservices.orangeplayer.vx.Equalizer.EqualizerHelper;
...
import com.tochycomputerservices.orangeplayer.vx.Utils.AudioManagerHelper;
...
import com.tochycomputerservices.orangeplayer.vx.Utils.SongDataHelper;
...
public class MusicService extends Service {
    ...
    Runnable mStopServiceRunnable = new Runnable() {
        @Override
        public void run() {
...
// To do update deprecated mHandler = new Handler();
        ...
        PendingIntent playPauseTrackPendingIntent = PendingIntent.getBroadcast(mContext, 56, intent, PendingIntent.FLAG_IMMUTABLE);
    ...
    // To do update deprecated  int result = mAudioManager.requestAudioFocus(audioFocusChangeListener, AudioManager.STREAM_MUSIC, AudioManager.AUDIOFOCUS_GAIN);
    ...
    // To do update deprecated SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
...
//            startPlaying();
    ...
    // To do update deprecated mMediaPlayer1.setAudioStreamType(AudioManager.STREAM_MUSIC);
    ...
    // To do update deprecated  mAudioManager.abandonAudioFocus(audioFocusChangeListener);
    ...
    // To do update deprecated new AsyncTask<Void, Void, Void>() {
    ...
    public void sendMediaIntentData() throws NumberFormatException {
        ...
        mBundle.putString("scrobbling_source", "com.music.songplayer");
    ...
    // To do update deprecate new AsyncTask<Void, Void, Void>() {
    ...
    private Notification mediaStyleNotification() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            // To do update deprecated builder = new NotificationCompat.Builder(this);
        } else {
        ...
        return builder
                ...
                .setSmallIcon(R.drawable.ic_music_file)
