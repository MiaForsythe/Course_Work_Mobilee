...
public class Constants {
    ...
    public static final String ACTION_PLAY_PAUSE = "com.music.songplayer.action.PLAY_PAUSE";
    public static final String ACTION_STOP = "com.music.songplayer.action.STOP";
    public static final String ACTION_NEXT = "com.music.songplayer.action.NEXT";
    public static final String ACTION_PREVIOUS = "com.music.songplayer.action.PREVIOUS";
    public static final String ACTION_PAUSE = "com.music.songplayer.action.PAUSE";

    public static final String ACTION_UPDATE_NOW_PLAYING_UI = "com.music.songplayer.action.UPDATE_NOW_PLAYING_UI";
