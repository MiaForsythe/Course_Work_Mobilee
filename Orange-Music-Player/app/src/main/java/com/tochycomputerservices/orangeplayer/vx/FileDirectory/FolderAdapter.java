package com.tochycomputerservices.orangeplayer.vx.FileDirectory;
        ...
        switch (viewHolder.getItemViewType()) {
            case 0:
                ...
                if (mFileFolderTypeList.get(position) == FolderFragment.FOLDER) {
                    holder.mIconImage.setImageResource(R.drawable.ic_folder_svgrepo_com);
            ...
            case 1:
                ...
                upHolder.mImageView.setImageResource(R.drawable.ic_folder_svgrepo_com);
