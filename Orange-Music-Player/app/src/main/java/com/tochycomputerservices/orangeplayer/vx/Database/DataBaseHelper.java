package com.tochycomputerservices.orangeplayer.vx.Database;
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String USER_CREDENTIALS_TABLE = "UserCredentialsTable";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createUserCredentialsTable = "CREATE TABLE " + USER_CREDENTIALS_TABLE + "(" +
        ...
        db.execSQL(createUserCredentialsTable);
    ...
    public void addUserCredentials(String username, String password) {
        ...
        try {
            getDatabase().insertOrThrow(USER_CREDENTIALS_TABLE, null, values);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean checkUserCredentials(String username, String password) {
        ...
        Cursor cursor = db.query(USER_CREDENTIALS_TABLE, null, selection, selectionArgs, null, null, null);
