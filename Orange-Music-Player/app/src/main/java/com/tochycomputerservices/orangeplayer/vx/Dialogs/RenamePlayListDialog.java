        ...
        builder.setPositiveButton(R.string.rename, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (name != null && name.length() > 0) {
                    ContentResolver resolver = RenamePlayListDialog.this.getActivity().getContentResolver();
                    ...
                    Toast.makeText(RenamePlayListDialog.this.getActivity(), R.string.play_list_renamed, Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                }
